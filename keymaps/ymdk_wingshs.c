...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
    ...
    MO(1),            KC_LGUI,          KC_SPC,  KC_LALT,          KC_SPC,  KC_GRV,                                       KC_LEFT, KC_DOWN, KC_RGHT
  ),

  [1] = LAYOUT_all(
    KC_GRV,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,   KC_DEL,           KC_MUTE,
    _______, _______, _______, _______, _______, _______, _______, KC_MRWD, KC_MPLY, KC_MFFD, _______, _______, _______, _______,           RGB_TOG,
